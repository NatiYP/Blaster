	...
	if (MuzzleFlashSocket && World) {
		...
		if (bUseServerSideRewind)
		{
			if (InstigatorPawn->HasAuthority()) // server
			{
				...
				else // server, not locally controlled - spawn non replicated projectile, use our ServerSideRewind
					// this character is controlled elsewhere, by a client.
				{
